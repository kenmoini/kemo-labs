...
STEPCA_ACME_URL="https://stepca.lab.kemo.network:9000/acme/acme/directory"
...
echo "   https://mail.lab.kemo.network"
...
echo "   mail.lab.kemo.network.              IN A     192.168.62.80"
echo ""
echo "   ; MX record"
echo "   lab.kemo.network.                   IN MX    10 mail.lab.kemo.network."
echo ""
echo "   ; Autodiscover / Autoconfig"
echo "   autodiscover.lab.kemo.network.      IN CNAME mail.lab.kemo.network."
echo "   autoconfig.lab.kemo.network.        IN CNAME mail.lab.kemo.network."
echo ""
echo "   ; SPF"
echo "   lab.kemo.network.                   IN TXT   \"v=spf1 mx a:mail.lab.kemo.network -all\""
echo ""
echo "   ; DKIM (generated after first run -- get from Mailcow admin UI)"
echo "   ; dkim._domainkey.lab.kemo.network. IN TXT   \"v=DKIM1; k=rsa; p=...\""
echo ""
echo "   ; DMARC"
echo "   _dmarc.lab.kemo.network.            IN TXT   \"v=DMARC1; p=quarantine; rua=mailto:postmaster@lab.kemo.network\""
echo ""
echo "   ; Reverse DNS (PTR) -- set at your ISP/hosting provider"
echo "   ; 80.62.168.192.in-addr.arpa.       IN PTR   mail.lab.kemo.network."
echo ""
